...
var decode = {a: 6, b: 1, d: 7, e: 4, i: 3, l: 2, m: 9, n: 8, o: 0, t: 5}


if (Number.isInteger(input)) !== true) {console.log ('Numbers only please!');}
else if ((input < 100) || (input < 999999)) {console.log ('Please input number between 100-999,999');}
